  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="w-full max-w-sm">
      ...
      <div class="bg-white border border-gray-200 rounded-lg p-8">
        <h1 class="text-lg font-semibold text-gray-900 mb-1">Create an account</h1>
        <p class="text-sm text-gray-500 mb-6">Register to start booking company equipment.</p>
...
const handleRegister = async () => {
  ...
  try {
    ...
    errorMessage.value = err.response?.data?.message || 'Failed to register';
  } finally {
    loading.value = false;
  }
};
